This repositorys includes a data pipeline to stream data from a Kaggle dataset capturing UK user behavior on Netflix browsing activity to Confluent Cloud.
